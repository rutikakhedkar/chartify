          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit} action="#">
              ...
              <button
                ...
                className={`w-full text-white bg-[#5f65e2] hover:bg-[#8489f0] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 ${sign_in_processing ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                {sign_in_processing ? (
              ...
              <p className="text-sm font-semibold text-primary-600 dark:text-primary-400">
                Don't have an account? <span onClick={() => { navigate("/signup") }} className="cursor-pointer font-bold ml-2 text-[#5f65e2] hover:underline dark:text-primary-500">Sign up</span>
              </p>
            </form>
          </div>
        </div>
